 ...
 */
@Data
public class WxMpSelfMenuInfoDTO implements Serializable {
    ...
    private List<WxMpSelfMenuButtonDTO> buttons;

    @Data
    public static class WxMpSelfMenuButtonDTO implements Serializable {
        ...
        public static class SubButtons implements Serializable {
            ...
            @SerializedName("list")
            private List<WxMpSelfMenuButtonDTO> subButtons = new ArrayList<>();
